...
CREATE TABLE `delivery_notes` (
	...
	`created_at` integer DEFAULT '"2026-03-18T06:45:07.316Z"',
...
CREATE TABLE `__new_cheque_registry` (
	...
	`client_id` integer,
	`supplier_id` integer,
	`created_at` integer DEFAULT '"2026-03-18T06:45:07.318Z"',
	FOREIGN KEY (`client_id`) REFERENCES `clients`(`id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `__new_clients` (
	...
	`address` text,
	`tax_number` text,
	`created_at` integer DEFAULT '"2026-03-18T06:45:07.315Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_purchase_orders` (
	...
	`total_incl_tax` real NOT NULL,
	`status` text DEFAULT 'pending',
	`created_at` integer DEFAULT '"2026-03-18T06:45:07.317Z"',
	FOREIGN KEY (`supplier_id`) REFERENCES `suppliers`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-18T06:45:07.314Z"'
);
--> statement-breakpoint
